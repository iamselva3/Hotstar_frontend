...
const RandomMoviePage1 = () => {
  ...
  useEffect(() => {
    const fetchRandomVideo = async () => {
      try {
        const response = await axios.get(`${process.env.REACT_APP_API_URL}/api/video1`);
  ...
  return (
    <div style={{ textAlign: "center", background: "#000", color: "#fff", padding: "30px", height: "150vh" }}>
...
export default RandomMoviePage1;
